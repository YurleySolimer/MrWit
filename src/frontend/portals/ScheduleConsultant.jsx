...
const ScheduleConsultant = ({ onClose }) => {
    ...
    if (schedule) {
        return (
            <div className="ScheduleConsultant">
                ...
                <button className='continueSchedule' onClick={handleClose}>Continuar</button>
            </div>
        )
    }
    ...
    return (
        <div className='ScheduleConsultant'>
            <Calendar
                ...
                prevLabel={<Prev />}
            />
            <h4>Horas disponibles el <b>06-02-2020</b> selecciona la que prefieras:</h4>
