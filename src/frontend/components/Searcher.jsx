...
const Searcher = (props) => {
  ...
  useEffect(() => {
    ...
    const { sectors, professions } = Matrix;
    const structuredProfessions = professions.map((profession) => Object.keys(profession)[0]);
    const list = [...sectors, ...structuredProfessions];
    autocomplete(document.getElementById('searcher'), list);
  }, []);
